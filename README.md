...
<details>
  ...
  Данный функциональный модуль является основным в работе приложения и реализует пользовательский режим (<a href="https://github.com/AndrewLaptev/ble_light_mobile/edit/main/README.md#user-mode">User mode</a>) работы приложения
